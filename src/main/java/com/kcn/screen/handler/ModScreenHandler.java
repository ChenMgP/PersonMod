...
public class ModScreenHandler {
    ...
    public static final ScreenHandlerType<AChestScreenHandler> A_CHEST_SCREEN_HANDLER;

    static {
        A_CHEST_SCREEN_HANDLER = ScreenHandlerRegistry.registerSimple(new Identifier("kcn", "a_chest"), AChestScreenHandler::new);
