...
import com.kcn.blocks.entities.AcaciaCisternEntity;
...
public class AcaciaCistern extends BlockWithEntity {
    public static final IntProperty WATER = IntProperty.of("water", 0, 5);

    public AcaciaCistern(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new AcaciaCisternEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntity.ACACIA_CISTERN_BLOCK_ENTITY, (world1, pos, state1, blockEntity) -> AcaciaCisternEntity.tick(world1, pos, blockEntity));
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.getBlockEntity(pos) instanceof AcaciaCisternEntity blockEntity) {
