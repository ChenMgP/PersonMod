...
public class DarkOakCistern1 extends Block {
    public DarkOakCistern1(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (player.getMainHandStack().getItem() == ModItem.DELETE_SCROLL) {
            ...
            world.spawnEntity(new ItemEntity(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItem.DARK_OAK_WOODEN_STAKE)));
        ...
        if (player.getMainHandStack().getItem() == ModItem.DARK_OAK_WOODEN_STAKE) {
            ...
            world.setBlockState(pos, ModBlock.DARK_OAK_CISTERN_2.getDefaultState());
