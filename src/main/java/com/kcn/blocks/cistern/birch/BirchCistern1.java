...
public class BirchCistern1 extends Block {
    public BirchCistern1(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (player.getMainHandStack().getItem() == ModItem.DELETE_SCROLL) {
            ...
            world.spawnEntity(new ItemEntity(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItem.BIRCH_WOODEN_STAKE)));
        ...
        if (player.getMainHandStack().getItem() == ModItem.BIRCH_WOODEN_STAKE) {
            ...
            world.setBlockState(pos, ModBlock.BIRCH_CISTERN_2.getDefaultState());
