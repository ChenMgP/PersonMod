...
public class Cistern extends BlockWithEntity {

    public static final IntProperty WATER = IntProperty.of("water", 0, 5);

    public Cistern(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new CisternEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntity.CISTERN_BLOCK_ENTITY, (world1, pos, state1, blockEntity) -> CisternEntity.tick(world1, pos, blockEntity));
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.getBlockEntity(pos) instanceof CisternEntity blockEntity) {
