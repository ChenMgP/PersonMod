...
public class Cistern3 extends Block {
    public Cistern3(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (player.getMainHandStack().getItem() == ModItem.DELETE_SCROLL) {
            ...
            world.spawnEntity(new ItemEntity(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItem.WOODEN_STAKE, 3)));
        ...
        if (player.getMainHandStack().getItem() == ModItem.WOODEN_STAKE) {
            ...
            world.setBlockState(pos, ModBlock.CISTERN_4.getDefaultState());
