...
public class SpruceCistern1 extends Block {
    public SpruceCistern1(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (player.getMainHandStack().getItem() == ModItem.DELETE_SCROLL) {
            ...
            world.spawnEntity(new ItemEntity(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItem.SPRUCE_WOODEN_STAKE)));
        ...
        if (player.getMainHandStack().getItem() == ModItem.SPRUCE_WOODEN_STAKE) {
            ...
            world.setBlockState(pos, ModBlock.SPRUCE_CISTERN_2.getDefaultState());
