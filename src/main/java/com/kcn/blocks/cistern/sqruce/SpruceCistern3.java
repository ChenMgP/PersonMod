...
public class SpruceCistern3 extends Block {
    public SpruceCistern3(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (player.getMainHandStack().getItem() == ModItem.DELETE_SCROLL) {
            ...
            world.spawnEntity(new ItemEntity(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItem.SPRUCE_WOODEN_STAKE, 3)));
        ...
        if (player.getMainHandStack().getItem() == ModItem.SPRUCE_WOODEN_STAKE) {
            ...
            world.setBlockState(pos, ModBlock.SPRUCE_CISTERN_4.getDefaultState());
