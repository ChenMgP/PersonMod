...
public class EOpenChestEntity extends LootableContainerBlockEntity {
    ...
    public EOpenChestEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntity.E_CHEST_BLOCK_ENTITY, blockPos, blockState);
    }

    public static void tick(EOpenChestEntity entity, World world, BlockPos pos) {
        if (!entity.is_opened) {
            for (int i = 0; i <= 3; i++) {
