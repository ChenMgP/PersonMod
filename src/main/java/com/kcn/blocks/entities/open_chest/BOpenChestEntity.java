...
public class BOpenChestEntity extends LootableContainerBlockEntity {
    ...
    public BOpenChestEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntity.B_OPEN_CHEST_ENTITY, blockPos, blockState);
    }

    public static void tick(BOpenChestEntity entity, World world, BlockPos pos) {
        if (!entity.is_opened) {
            for (int i = 0; i <= 3; i++) {
