...
public class DOpenChestEntity extends LootableContainerBlockEntity {
    ...
    public DOpenChestEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntity.D_OPEN_CHEST_ENTITY, blockPos, blockState);
    }

    public static void tick(DOpenChestEntity entity, World world, BlockPos pos) {
        if (!entity.is_opened) {
            for (int i = 0; i <= 3; i++) {
