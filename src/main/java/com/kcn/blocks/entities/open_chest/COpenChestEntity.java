...
public class COpenChestEntity extends LootableContainerBlockEntity {
    ...
    public COpenChestEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntity.C_OPEN_CHEST_ENTITY, blockPos, blockState);
    }

    public static void tick(COpenChestEntity entity, World world, BlockPos pos) {
        if (!entity.is_opened) {
            for (int i = 0; i <= 3; i++) {
